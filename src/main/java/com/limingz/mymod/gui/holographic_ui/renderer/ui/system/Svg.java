...
public class Svg extends UIComponent{
    ...
    private static final ResourceLocation SVG_LOCATION = ResourceLocation.fromNamespaceAndPath(Main.MODID, "svg/wiki_into/data-frame-120.svg");
    ...
    public void render(MultiBufferSource bufferSource, PoseStack poseStack, int combinedOverlay, float x, float y, BlockEntity blockEntity) {
        ...
        // 1. 获取SVG纹理ID
        ResourceLocation textureId = SVGTextureManager.getOrCreateTexture(SVG_LOCATION, 1920, 1080);
